------------------------------------------------------------ Sparse Matrix ----------------------------------------------------------------------------------------
Sparse Matrix = A matrix that contains most of its elements as 0
Objective : Save only the elements different from 0 from cols and rows using a linear linked list, and when showing the list rebuild them again as the initial list
-------------------------------------------------------------------------------------------------------------------------------------------------------------------
